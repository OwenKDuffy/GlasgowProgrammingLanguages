...
public interface FunListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterRange(@NotNull FunParser.RangeContext ctx);
	/**
	 * Exit a parse tree produced by {@link FunParser#range}.
	 * @param ctx the parse tree
	 */
	void exitRange(@NotNull FunParser.RangeContext ctx);
	/**
	 * Enter a parse tree produced by the {@code case_statement}
	 * labeled alternative in {@link FunParser#case_stmt}.
	 * @param ctx the parse tree
	 */
	void enterCase_statement(@NotNull FunParser.Case_statementContext ctx);
	/**
	 * Exit a parse tree produced by the {@code case_statement}
	 * labeled alternative in {@link FunParser#case_stmt}.
	 * @param ctx the parse tree
	 */
	void exitCase_statement(@NotNull FunParser.Case_statementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FunParser#default_case}.
	 * @param ctx the parse tree
	 */
	void enterDefault_case(@NotNull FunParser.Default_caseContext ctx);
	/**
	 * Exit a parse tree produced by {@link FunParser#default_case}.
	 * @param ctx the parse tree
	 */
	void exitDefault_case(@NotNull FunParser.Default_caseContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterForloop(@NotNull FunParser.ForloopContext ctx);
	/**
	 * Exit a parse tree produced by the {@code forloop}
	 * labeled alternative in {@link FunParser#com}.
	 * @param ctx the parse tree
	 */
	void exitForloop(@NotNull FunParser.ForloopContext ctx);
	/**
