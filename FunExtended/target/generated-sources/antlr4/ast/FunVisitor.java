...
public interface FunVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitForloop(FunParser.ForloopContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FunParser#default_case}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDefault_case(FunParser.Default_caseContext ctx);
	/**
	 * Visit a parse tree produced by the {@code case_statement}
	 * labeled alternative in {@link FunParser#case_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCase_statement(FunParser.Case_statementContext ctx);
	/**
