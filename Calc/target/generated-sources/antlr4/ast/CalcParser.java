	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PLUS) | (1L << MINUS) | (1L << TIMES))) != 0)) {
				...
				{
				setState(31);
				((OpContext)_localctx)._tset68 = _input.LT(1);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PLUS) | (1L << MINUS) | (1L << TIMES))) != 0)) ) {
					((OpContext)_localctx)._tset68 = (Token)_errHandler.recoverInline(this);
				}
				else {
				...
				((OpContext)_localctx).operator.add(((OpContext)_localctx)._tset68);
				setState(32);
				prim();
				}
				}
